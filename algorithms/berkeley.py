...
class BerkeleyAlgorithm(ClockSyncAlgorithm):
    ...
    def server_process(self, name, sock: socket.socket) -> None:
        ...
        # 2. 计算时间偏移
        # 获取协调者的时间
        coordinator_time = self.get_simulated_time()
        ...
        self.cumulative_offset += coordinator_offset  # 更新协调者的时间偏移量
        print(
    ...
    def client_process(
        ...
        try:
            ...
            self.cumulative_offset += adjustment  # 更新客户端的时间偏移量
            print(
